    ...
    INSPIRO.loader = function () {
        ...
        if (!$body.hasClass('no-page-loader')) {
            ...
            var pageInAnimation = $body.attr('data-animation-in') || "fadeIn",
                ...
                pageLoaderStylePath = $body.attr('data-animation-icon-path') || "/images/svg-loaders/ring.svg",
            ...
            $wrapper.animsition({
                ...
                loadingInner: '<img src="images/svg-loaders/ring.svg">', // e.g '<img src="loading.svg" />'
                timeout: false,
